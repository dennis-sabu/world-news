...
export default async function TechnologyPage() {
  ...
  const primaryNav = buildPrimaryNav("technology");

  // Fetch technology articles from RSS
  const techArticles = await getSectionArticles({
    type: "rss",
    category: "technology",
    label: "Technology",
    pageSize: 100,
  ...
  const [heroArticle, ...rest] = techArticles;
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        <header className="mb-10 space-y-4 border-b border-neutral-200 pb-8 text-center">
          ...
          <p className="mx-auto max-w-2xl text-sm leading-relaxed text-neutral-600 sm:text-base">
            Innovation, startups, and the digital forces redefining daily life.
          </p>
        </header>
