...
export default async function SportPage() {
  ...
  const primaryNav = buildPrimaryNav("sport");

  // Fetch sports articles from RSS
  const sportArticles = await getSectionArticles({
    type: "rss",
    category: "sports",
    label: "Sport",
    pageSize: 100,
  ...
  const [heroArticle, ...rest] = sportArticles;
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        <header className="mb-10 space-y-4 border-b border-neutral-200 pb-8 text-center">
          ...
          <p className="mx-auto max-w-2xl text-sm leading-relaxed text-neutral-600 sm:text-base">
            Scores, analysis, and behind-the-scenes reporting across every discipline.
          </p>
        </header>
