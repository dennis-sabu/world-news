...
export default async function EntertainmentPage() {
  ...
  const primaryNav = buildPrimaryNav("entertainment");

  // Fetch entertainment articles from RSS
  const entertainmentArticles = await getSectionArticles({
    type: "rss",
  ...
  const [heroArticle, ...rest] = entertainmentArticles;
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        <header className="mb-10 space-y-4 border-b border-neutral-200 pb-8 text-center">
          ...
          <p className="mx-auto max-w-2xl text-sm leading-relaxed text-neutral-600 sm:text-base">
            Film, television, music, and celebrity stories making headlines.
          </p>
        </header>
