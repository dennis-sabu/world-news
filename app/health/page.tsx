...
export default async function HealthPage() {
  ...
  const primaryNav = buildPrimaryNav("health");

  // Fetch health articles from RSS
  const healthArticles = await getSectionArticles({
    type: "rss",
    category: "health",
    label: "Health",
    pageSize: 100,
  ...
  const [heroArticle, ...rest] = healthArticles;
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        <header className="mb-10 space-y-4 border-b border-neutral-200 pb-8 text-center">
          ...
          <p className="mx-auto max-w-2xl text-sm leading-relaxed text-neutral-600 sm:text-base">
            Medical research, wellness trends, and public health updates.
          </p>
        </header>
